...
public class ClassEx_02 {
	...
	public static void main(String[] args) {
		...
		ClassServiceV1 cs;// cs 객체 선언하기 // 아직 cs 객체를 사용할 수 없는 상태!!
		cs = new ClassServiceV1(); // cs 객체 초기화, 생성 // cs는 인스턴스가 되었다 //cs객체를 사용할 수 있는 상태
		//==> ClassServiceV1 클래스에 선언된 method를 호출할 수 있다
