 ...
 * 클래스는 첫 글자를 대문자로 시작하는 이름을 가져야 한다
 * 중간에 숫자 _ 를 포함할수 있다
 * 빈칸이나 기타 특수 문자는 포함할수 없다
 * 
 * 나는 3개의 method 를ㄹ 가지고 있습니다
 * method의 첫글자는 소문자로 시작하는 이름을 가져야한다
 * 변수명을 짓는 규칙과 같다
 * 
 * 나는 더 많은 method 를 가질수 있으며,
 * 더욱 다양한 명령들을 한데 묶어 포함할수 있습니다
 * 내가 포함 method 는 static 이 없으므로
 * 내가 가지고 있는 method 를 실행 하려면
...
public class Class_01 {
	...
	public void method_03() {
		...
		System.out.println("Class 01의 세번째 메서드 입니다");
	}
