...
public class KeyInput_02 {
	...
	public static void main(String[] args) {
		...
		//String(클래스) 형 변수를 선언 및 생성하는 원형 문법
		String strNation = new String("대한민국");
		
		// String 형 변수는 클래스이지만
		// 사용 편의성을 위해서 일반 변수처럼 선언, 생성할수 있도록
		 ...
		 * 키보드에서 무엇인가 입력되기를 기다린다
		 * Enter 키를 누를때까지 마냥 기다리기만 한다
		 */
		strKeyIn = scanner.nextLine();
		System.out.println("키보드에서 입력된 문자열 : " + strKeyIn);
