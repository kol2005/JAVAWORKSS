...
// 2. 멤버변수를 선언하고
// 3. 정보은닉 : 멤버변수의 접근제한자를 기본으로 private 으로 선언
// 4. 캡슐화 : 은닉된 멤버변수를 접근할수 있는 통로를 설정
//		getter() setter() method 를 생성, 선언

//		만약 vo.strName = "Java" 라는 코드로
//		vo 클래스의 strName 변수에 Java 문자열을 저장하려 할때
//		strName 변수를 private 으로 만들면
//		setter() 메서드를 통해서 값을 저장해야 한다

//		즉, vo.setstrName("Java")라는 코드를 사용해야한다
//		우리의 목적은 strName 이라는 멤버변수에
//		Java라는 문자열을 저장하는 것 뿐이다

//		결국 목적은 하나이지만
//		변수에 직접 접근하느냐
//		setter() method 를 통해서 접근하느냐 의 차이이며
//		vo 클래스의 setter() 메서드가
//		내부적으로 어떤 일(연산)을 수행하는지 몰라도
//		목적은 달성 할수 있다
public class BookVO {
	...
	// setStrNum("9700001")
	// 멤버변수 strNum = "9700001" 이런 코드를 실행한 것과 같다
	public void setStrNum(String strNum) {
		
		// 캡슐화
		// setStrNum() method 에 아래와 같은 코드가 있더라도
		// 외부에서는 아무런 관심없다
		int sum = 30 + 40 + 50 + 60 + 70;
		sum += 30;
		sum -= 20;
		
		// this.strnum 는 멤버변수를 가리킨다
		// 			= strNum 는 매개변수의 값을 멤버변수에 할당하라
		this.strNum = strNum;
	}
