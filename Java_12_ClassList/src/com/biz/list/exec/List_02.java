...
public class List_02 {
	...
	public static void main(String[] args) {
		...
		// interface 에 구현되지 않은
		// input(int count) method 를 호출해서 사용하려면
		// bs 객체를 BookServiceImpV1 class 로 형변환을 해야한다
		// 이 코드로 인해서 interface를 활용하는 의미가
		//		일부 퇴색된다
		// 그래서 
		// 만약 input(int count) 처럼 처음에 interface 를 만들때
		// 없던 method 를 사용하려면
		// 가급적 설계자에게 요청하여
		// interface 에 등록하도록 하는것이 좋은 방법
