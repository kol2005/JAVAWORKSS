...
public class IolistServiceImp {
	...
	public void input() {
		 ...
		 * 4개으 ㅣ매개변수가 있는 생성자가 작동되어
		 * 객체를 만든다
		 */
		iolistVO = new IolistVO("2019-09-05","14:00:01","cj햇반",1500);
		iolist.add(iolistVO);
		
		iolistVO = new IolistVO("2019-09-05","14:00:02","cj햇반",1600);
		iolist.add(iolistVO);
		
		iolistVO = new IolistVO("2019-09-05","14:00:03","cj햇반",1700);
		iolist.add(iolistVO);
		
		iolistVO = new IolistVO("2019-09-05","14:00:04","cj햇반",1800);
		iolist.add(iolistVO);
		
		iolistVO = new IolistVO("2019-09-05","14:00:05","cj햇반",1900);
		iolist.add(iolistVO);
	...
	public void input(int count) {
		...
		int intQty = rnd.nextInt(30)+10;//10 ~ 39 까지 난수
	...
	public void list() {
		...
		System.out.println("=============================================");
		System.out.println("일자\t\t시각\t\t상품명\t\t단가\t수량\t상품금액");
		System.out.println("---------------------------------------------");
		for(IolistVO vo : iolist) {
