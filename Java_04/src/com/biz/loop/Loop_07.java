...
public class Loop_07 {
	...
	public static void main(String[] args) {
		 ...
		 * for 키워드 첫번째 명령문 = count 를 reset 하는 명령
		 * 
		 */
		//nCount = 0;
		...
		/*
		 * for 반복문이 실행될때 만약 카운트를 증감하는
		 * 명령문이 없으면 for 반복문은 무한반복이 될것이다
		 * 따라서 카운트 증감 명령문도 매우 중요한 명령문이다
		 * 어차피 증감을 해야하는 명령문이 반드시 필요하므로
		 * 빼먹지 않도록 적절한 조치를 취할 필요가있다
		 * 
		 * 그래서 for 키워드의 () 명령문 중 3번째 명령문 위치에
		 * 카운트 증감 명령문을 넣을 수 있다
		 */
		//nCount = 0;
