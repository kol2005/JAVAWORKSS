...
public class Array_01 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 리스트(List) 데이터들의 묶음 숫자리스트, 문자리스트 등 다양한 종류
		 */

		// 숫자 리스트를 순서대로 표현하는 방법
		// =console 에 숫자 리스트를 순서대로 표시하는 방법

		// 5 부터 22까지 숫자를 console 에 나열하고 싶다
		// i 값이 22까지( i <= 22의 조건이 참인 동안)
		// 명령문을 반복적으로 실행해서
		// 뭔가를 표현하라
		for (int i = 5; i <= 22; i++) {
		...
		// 저장된 값들을 console 에 리스트로 표시하는 방법

		// 정수형 배열 nums를 선언하고
		// 요소를 100개를 생성하겠다
		int[] nums = new int[100];

		// nums 배열의 요소 100에 어떤 값을 저장
		nums[0] = 5;
		nums[1] = 6;
		nums[2] = 7;
		nums[10] = 22;
